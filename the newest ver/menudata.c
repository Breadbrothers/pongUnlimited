...
uint8_t screenbuffer[512];

const uint8_t icon[] = {
	0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x7E, 0x66, 0x99, //Row 1 Q1
	0xFF, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, //Row 1 Q2
	0xFF, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, //Row 1 Q3
	0x00, 0x7E, 0x66, 0x99, 0xFF, 0xff, 0xff, 0xff, //Row 1 Q4
	0xFF, 0x3F, 0x1F, 0x0F, 0x0F, 0x07, 0x07, 0x03, //Row 2 Q1
	0x03, 0x01, 0x01, 0x3F, 0x01, 0, 0, 0, //Row 2 Q2
	0, 0, 0, 0x01, 0x3F, 0x01, 0x01, 0x03, //Row 2 Q3
	0x03, 0x07, 0x07, 0x0F, 0x0F, 0x1F, 0x3F, 0xFF, //Row 2 Q4
	0xFF, 0xF0, 0xE0, 0xE0, 0xC0, 0x80, 0x80, 0x80, //Row 3 Q1
	0, 0, 0, 0, 0, 0, 0, 0, //Row 3 Q2
	0, 0, 0, 0, 0, 0, 0, 0, //Row 3 Q3
	0x80, 0x80, 0x80, 0xC0, 0xE0, 0xE0, 0xF0, 0xFF, //Row 3 Q4
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, //Row 4 Q1
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, //Row 4 Q2
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, //Row 4 Q3
	0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, //row 4 Q4
};
...
const uint8_t const bread_icon[] = {
	0x00,0x00,0x00,0x00,0x00,0x1f,0xc0,0x00
	,0x01,0xff,0xf8,0x80,0x07,0xff,0xfe,0x60
	,0x0f,0xff,0xff,0xb0,0x1f,0xff,0xff,0xd8
	,0x3f,0xff,0xff,0xdc,0x7f,0xff,0xff,0xec
	,0x7f,0xff,0xff,0xee,0x7f,0xff,0xff,0xee
	,0x7f,0xff,0xff,0xee,0x7f,0xff,0xff,0xee
	,0x3f,0xff,0xff,0xfc,0x3f,0xff,0xff,0xd8
	,0x0f,0xff,0xff,0xb0,0x0f,0xff,0xff,0x70
	,0x0f,0xbf,0xf7,0x70,0x0e,0x3f,0xe7,0x70
	,0x0f,0xff,0xff,0x70,0x0f,0xff,0xff,0x70
	,0x0f,0xff,0xff,0x70,0x0f,0xff,0xff,0x70
	,0x0f,0xff,0xff,0x70,0x0f,0xff,0xff,0x70
	,0x0f,0xff,0xff,0x70,0x0f,0xff,0xff,0x70
	,0x0f,0xff,0xff,0xf0,0x0f,0xff,0xff,0xf0
	,0x0f,0xff,0xff,0xf0,0x0f,0xff,0xff,0x60
